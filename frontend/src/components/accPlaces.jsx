    ...
    <div className="flex w-full max-w-7xl flex-col items-center">
      {action !== "new" ? (
        <div className="flex flex-col gap-8 items-center">
          ...
          {places.map((place) => (
            <Link to={`/account/places/new/${place._id}`} className="bg-gray-100 rounded-2xl p-6 flex gap-6 items-center"
            key={place._id}>
              <img className="max-w-56 object-center aspect-square rounded-2xl" src={place.photos[0]} alt="Foto da Acomodação" />
